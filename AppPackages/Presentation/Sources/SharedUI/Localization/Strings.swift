...
public enum Strings {
    ...
    public static let battery = String(localized: "Battery")
    ...
    public static let lastReading = String(localized: "Last Reading")
    ...
    public static let noTemperatureDataAvailable =
        String(localized: "No temperature data available")
    ...
    public static let temperature = String(localized: "Temperature")
    public static let temperatureSensor =
        String(localized: "Temperature Sensor")
    public static let type = String(localized: "Type")
